...
/**
 * Test class for ZeroR mapper and reducer
 * <p>
...
public class BankZRTest {
   ...
   private static void setUp() {
      ...
      BankZR.BankZRMapper mapper = new BankZR.BankZRMapper();
      mapDriver = MapDriver.newMapDriver(mapper);
      /** instantiate a reducer object and reducer driver*/
      BankZR.BankZRReducer reducer = new BankZR.BankZRReducer();
      reduceDriver = ReduceDriver.newReduceDriver(reducer);
   }

   /* Testing the mapper by comparing its output to an expected output in the file mymaptest.dat
   ...
   */
   ...
   /** Splitting the expected output into key and value pair to be able to match them against the reducer's output*/
      ...
      /** Expected output value.*/
      String outputValue = outputStringArray[1];
      /** Calling reducer and comparing its output with the expected one.*/
      reduceDriver
