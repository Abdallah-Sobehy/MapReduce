...
/**
 * Mapper class for OneR algorithm of a bank dataset
   ...
   public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
	...
	for ( i = 0 ; i < tokensCount - 1 ; i ++ )
	{
		...
		switch (i)
		{
			...
			// Second column: job, write key: job and corresponding value from the file.
			case 1 :
			...
			// forth column: education, write key: education and corresponding value from the file.
			case 3 :
