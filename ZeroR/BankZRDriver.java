...
/**
 * Driver class for ZeroR algorithm of a bank dataset
 ...
 */
public class BankZRDriver extends Configured implements Tool {
/**
...
*/
   public int run(String[] args) throws Exception {
      if (args.length != 2) {
         System.err.println("usage: hadoop jar -classpath $CLASSPATH:BankZR.jar BankZR.BankZRDriver <inputfile> <outputdir>");
         System.exit(1);
      }
      /** Setting up the job */
      Job job = new Job(getConf());
 	/** Set the driver class */
      job.setJarByClass(BankZRDriver.class);
      /** Set the mapper class */
      job.setMapperClass(BankZRMapper.class);
      /** Set the reducer class */
      job.setReducerClass(BankZRReducer.class);
   ...
   public static void main(String[] args) throws Exception { 
      ...
      System.exit(ToolRunner.run(conf, new BankZRDriver(), args));
   } 
}
